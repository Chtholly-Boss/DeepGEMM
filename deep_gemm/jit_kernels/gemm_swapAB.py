...
def gemm_fp8_fp8_bf16_nt_swapAB(lhs: Tuple[torch.Tensor, torch.Tensor],
    ...
    """
    Perform a A-B Swaped normal GEMM with FP8 inputs and BF16 output, with 1x128 LHS scaling and 128x128 RHS scaling.
    ...
    runtime = build('gemm_fp8_fp8_bf16_nt', code, FP8GemmSwapABRuntime, kwargs)
    runtime(**kwargs)
